            ...
            <>
              ...
              {isLearner && (
                <>
                  ...
                  <Link to='/learner' className='text-slate-700 hover:text-teal-600 font-medium text-sm font-semibold text-teal-700 px-3 py-1 rounded-full bg-teal-50'>Learner Dashboard</Link>
                </>
              )}
            </>
          )}
