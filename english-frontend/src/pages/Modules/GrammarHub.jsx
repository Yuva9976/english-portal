      ...
      <div className="mb-16 max-w-6xl mx-auto px-4">
        <div className="mx-auto max-w-4xl">
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div className="absolute inset-0 bg-gradient-to-r from-teal-50 to-cyan-50 opacity-60" aria-hidden />
            ...
            <div className="h-2 bg-gradient-to-r from-teal-400 via-cyan-300 to-rose-300" aria-hidden />
          </div>
        </div>
      </div>
