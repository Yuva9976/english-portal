    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Grammar Hub</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Master English grammar with comprehensive lessons, interactive quizzes, and expert resources</p>
        </div>
        <div className="bg-white rounded-lg shadow-md p-8 mb-10 max-w-4xl mx-auto border border-gray-200">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-md p-6 border-t-4 border-teal-400 hover:shadow-lg transition-all duration-300">
              <div className="text-center mb-3">
                <span className="text-3xl">🏰</span>
              </div>
            ...
            <div className="bg-gradient-to-br from-rose-50 to-rose-100 rounded-lg shadow-md p-6 border-t-4 border-rose-400 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-teal-600 font-semibold mb-3 text-center">(1500-Present)</p>
              <p className="text-gray-700 text-sm leading-relaxed text-center">
        ...
        <div className="mb-12 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <button onClick={() => setShowEnhancedQuizzes(true)} className="group bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl shadow-md hover:shadow-2xl p-6 text-center transition-all duration-300 border-2 border-yellow-200 hover:border-yellow-400 flex flex-col items-center justify-center min-h-[140px] transform hover:-translate-y-2">
              <span className="text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">✍️</span>
              <span className="text-base font-bold text-gray-800">Grammar Quizzes</span>
            </button>
          </div>
        </div>

        <div className="mb-12 max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-md border-2 border-purple-200 overflow-hidden hover:shadow-lg transition-all duration-300">
            <div className="bg-gradient-to-r from-purple-500 to-blue-500 p-6">
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="bg-white text-purple-600 font-semibold px-6 py-3 rounded-lg hover:bg-purple-50 transition-all duration-300 shadow-md hover:shadow-lg flex items-center space-x-2"
                >
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-purple-600 mb-6 text-center">Parts of Speech</h2>
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg mb-6 max-w-4xl mx-auto">
            <p className="text-sm text-gray-700 leading-relaxed">
              <span className="font-semibold text-blue-700">What are Parts of Speech?</span> Parts of speech are categories that describe the function of words in a sentence. Understanding these 8 fundamental categories helps you construct grammatically correct sentences and communicate effectively.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            
            {/* Noun */}
            <div className="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-blue-500 hover:-translate-y-1">
              <div className="text-center mb-3">
            ...
            {/* Verb */}
            <div className="group bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-purple-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">🏃</span>
              </div>
            ...
            {/* Adjective */}
            <div className="group bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-pink-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">✨</span>
              </div>
            ...
            {/* Adverb */}
            <div className="group bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-yellow-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">⚙️</span>
              </div>
            ...
            {/* Preposition */}
            <div className="group bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-indigo-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">🌉</span>
              </div>
            ...
            {/* Conjunction */}
            <div className="group bg-gradient-to-br from-red-50 to-red-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-red-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">�</span>
              </div>
            ...
            {/* Interjection */}
            <div className="group bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-md hover:shadow-lg p-5 transition-all duration-300 border-l-4 border-teal-500 hover:-translate-y-1">
              <div className="text-center mb-3">
                <span className="text-3xl group-hover:scale-110 transition-transform duration-300 inline-block">❗</span>
              </div>
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-purple-600 mb-8 text-center">Recommended Grammar Resources</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition border border-gray-200">
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition border border-gray-200">
              <div className="flex items-start mb-4">
                <span className="text-4xl mr-3">📚</span>
                <div className="flex-1">
                  <h3 className="font-bold text-purple-600 text-lg mb-2">Oxford Learner's</h3>
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    Authoritative grammar reference from Oxford University Press with detailed examples
                  </p>
                  <a href="https://www.oxfordlearnersdictionaries.com/grammar/" target="_blank" rel="noopener noreferrer" className="inline-block px-4 py-2 text-sm font-medium bg-purple-600 text-white rounded-md hover:bg-purple-700 transition">
        ...
        <div className="mb-12 bg-white rounded-lg shadow-md p-8">
          <h2 className="text-3xl font-bold text-purple-600 mb-8 text-center">Quick Reference</h2>
              ...
              <div className="space-y-3">
                <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-red-700 line-through mb-1">I seen that movie</p>
                      <p className="text-sm text-green-700 font-semibold mb-1">✓ I saw that movie</p>
                      <p className="text-xs text-gray-600 italic">Use simple past tense, not past participle</p>
                    </div>
                  </div>
                </div>
                <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                  <div className="flex items-start">
                    <span className="text-red-500 font-bold mr-2 text-lg">✗</span>
                    <div className="flex-1">
                      <p className="text-sm text-red-700 line-through mb-1">Me and John went</p>
                      <p className="text-sm text-green-700 font-semibold mb-1">✓ John and I went</p>
                      <p className="text-xs text-gray-600 italic">Subject pronouns come first; use 'I' not 'me'</p>
                    </div>
                  </div>
                </div>
                <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                  <div className="flex items-start">
                    <span className="text-red-500 font-bold mr-2 text-lg">✗</span>
                    <div className="flex-1">
                      <p className="text-sm text-red-700 line-through mb-1">Your going there</p>
                      <p className="text-sm text-green-700 font-semibold mb-1">✓ You're going there</p>
                      <p className="text-xs text-gray-600 italic">You're = you are; your = possessive</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b-2 border-cyan-300">
                      <th className="text-left py-2 px-2 font-bold text-cyan-800">Base</th>
                      <th className="text-left py-2 px-2 font-bold text-cyan-800">Past</th>
                      <th className="text-left py-2 px-2 font-bold text-cyan-800">Past Participle</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-cyan-200">
                      <td className="py-2 px-2 text-gray-700">go</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">went</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">gone</td>
                    </tr>
                    <tr className="border-b border-cyan-200">
                      <td className="py-2 px-2 text-gray-700">see</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">saw</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">seen</td>
                    </tr>
                    <tr className="border-b border-cyan-200">
                      <td className="py-2 px-2 text-gray-700">eat</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">ate</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">eaten</td>
                    </tr>
                    <tr className="border-b border-cyan-200">
                      <td className="py-2 px-2 text-gray-700">write</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">wrote</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">written</td>
                    </tr>
                    <tr>
                      <td className="py-2 px-2 text-gray-700">take</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">took</td>
                      <td className="py-2 px-2 text-gray-800 font-semibold">taken</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        {/* Learning Tips */}
        <div className="bg-gradient-to-br from-indigo-100 to-cyan-100 rounded-lg shadow-md p-8 mb-12">
          <h2 className="text-2xl font-bold text-indigo-700 mb-6 text-center">Grammar Learning Tips</h2>
          <div className="grid sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
            ...
            <div className="flex items-start space-x-3 bg-white rounded-lg p-5 shadow-sm">
              <span className="text-2xl flex-shrink-0">✅</span>
              <p className="text-gray-700 text-sm leading-relaxed">Read English texts to see grammar in context</p>
            </div>
            <div className="flex items-start space-x-3 bg-white rounded-lg p-5 shadow-sm">
              <span className="text-2xl flex-shrink-0">✅</span>
              <p className="text-gray-700 text-sm leading-relaxed">Complete exercises after every lesson</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {/* FAQ Section */}
          <div>
            <h2 className="text-2xl font-bold text-purple-600 mb-6 text-center">Frequently Asked Questions</h2>
            <div className="space-y-4">
              <details className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden group">
                <summary className="cursor-pointer p-4 font-semibold text-gray-800 hover:bg-gray-50 transition-colors flex items-center justify-between text-sm">
                ...
                <div className="p-4 pt-0 text-gray-700 text-sm leading-relaxed border-t border-gray-100">
          ...
          {/* Study Plan Section */}
          <div>
            <h2 className="text-2xl font-bold text-purple-600 mb-6 text-center">Your Grammar Learning Journey</h2>
            <div className="space-y-4">
              <div className="flex items-start space-x-3 bg-white rounded-lg p-4 shadow-md border-l-4 border-blue-500">
                <div className="bg-blue-100 rounded-full p-2 flex-shrink-0">
                  <span className="text-xl">1️⃣</span>
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-gray-800 mb-1 text-sm">Week 1-2: Foundation</h3>
                  <p className="text-xs text-gray-600 mb-2">Learn the 8 parts of speech and basic sentence structure</p>
              ...
              <div className="flex items-start space-x-3 bg-white rounded-lg p-4 shadow-md border-l-4 border-green-500">
                <div className="bg-green-100 rounded-full p-2 flex-shrink-0">
                  <span className="text-xl">2️⃣</span>
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-gray-800 mb-1 text-sm">Week 3-4: Tenses</h3>
                  <p className="text-xs text-gray-600 mb-2">Master present, past, and future tenses with practice exercises</p>
                  <div className="flex gap-2 flex-wrap">
              ...
              <div className="flex items-start space-x-3 bg-white rounded-lg p-4 shadow-md border-l-4 border-purple-500">
                <div className="bg-purple-100 rounded-full p-2 flex-shrink-0">
                  <span className="text-xl">3️⃣</span>
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-gray-800 mb-1 text-sm">Week 5-6: Advanced Structures</h3>
                  <p className="text-xs text-gray-600 mb-2">Complex sentences, conditionals, and passive voice</p>
                  <div className="flex gap-2 flex-wrap">
              ...
              <div className="flex items-start space-x-3 bg-white rounded-lg p-4 shadow-md border-l-4 border-yellow-500">
                <div className="bg-yellow-100 rounded-full p-2 flex-shrink-0">
                  <span className="text-xl">4️⃣</span>
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-gray-800 mb-1 text-sm">Week 7+: Practice & Perfect</h3>
                  <p className="text-xs text-gray-600 mb-2">Regular quizzes, writing practice, and real-world application</p>
                  <div className="flex gap-2 flex-wrap">
            ...
            <div className="mt-6 text-center">
              <button onClick={() => navigate('/modules/learn-english/grammar')} className="bg-purple-600 text-white font-semibold px-6 py-2 rounded-lg hover:bg-purple-700 shadow-md hover:shadow-lg transition-all duration-300 text-sm">
                Start Your Journey →
              </button>
            </div>
          </div>
