        ...
        <div className="container mx-auto max-w-6xl px-4 py-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold">Adverbs</h1>
                <p className="text-sm md:text-base text-blue-100">Modify verbs, adjectives and other adverbs</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {sections.map(s => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs md:text-sm font-semibold transition-all ${activeSection === s.id ? 'bg-white text-blue-600 shadow-md' : 'bg-blue-500 bg-opacity-40 text-white hover:bg-opacity-60'}`}>
