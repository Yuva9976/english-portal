        ...
        <div className="container mx-auto max-w-6xl px-4 py-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold">Prepositions</h1>
                <p className="text-sm md:text-base text-blue-100">Connecting words in English</p>
              </div>
            </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
              {prepositionTypes.map((prep) => (
                <div key={prep.id} className={`bg-gradient-to-br from-${prep.color}-50 to-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-${prep.color}-200 overflow-hidden flex flex-col h-full`}>
                  <div className={`bg-gradient-to-r from-${prep.color}-100 to-${prep.color}-50 px-4 py-3 border-b-2 border-${prep.color}-200`}>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-2xl">{prep.icon}</span>
                      <h3 className={`text-base font-bold text-${prep.color}-800`}>{prep.type}</h3>
                    </div>
                  </div>
                  <div className="p-4 flex-1 flex flex-col">
                    <p className="text-sm text-gray-700 leading-relaxed mb-3">{prep.definition}</p>
