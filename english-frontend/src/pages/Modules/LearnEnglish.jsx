      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {defaultSkills.map((skill) => (
            <div
              key={skill.slug}
              className="group relative bg-white rounded-xl shadow-lg hover:shadow-2xl hover:shadow-teal-200 transition-all duration-300 border-2 border-gray-100 hover:border-teal-400 overflow-hidden transform hover:scale-105"
            >
              {/* Gradient top accent */}
